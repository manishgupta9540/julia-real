...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('faq-update')}}"  method="POST" id="aboutupdate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="hidden" name="id" value="{{base64_encode($faq_data->id)}}">
                                            <label for="role" class="form-control-label font-weight-300">Title<span class="text-danger">*</span></label>
                                            <input type="text" name="title"  class="form-control" value="{{$faq_data->title}}" placeholder="Title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control description" id="description" placeholder="Enter the Description"name="description">{{$faq_data->description}}</textarea>
