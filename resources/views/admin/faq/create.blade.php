...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('faq-create')}}"  method="POST" id="aboutcreate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Create a New Faq </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="role" class="form-control-label font-weight-300">FAQs Type<span class="text-danger">*</span></label>
                                            <select name="faq_type" class="form-control">
                                                <option value="">Select Type</option>
                                                <option value="1">Verkoop</option>
                                                <option value="2">koop</option>
                                                {{-- <option value="3">Koop</option> --}}
                                            </select>
                                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-faq_type"></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success==true) {   
                            ...
                            window.setTimeout(function() {
                                window.location.href = "{{URL::to('admin/faq')}}"
                            }, 2000);
                        }
