...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('about-update')}}"  method="POST" id="aboutupdate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Edit About </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="hidden" name="id" value="{{base64_encode($about_data->id)}}">
                                            <label for="role" class="form-control-label font-weight-300">Title<span class="text-danger">*</span></label>
                                            <input type="text" name="title"  class="form-control" value="{{$about_data->title}}" placeholder="Title">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control description" id="description" placeholder="Enter the Description"name="description">{{$about_data->description}}</textarea>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response.success==true) {   
                                ...
                                window.setTimeout(function() {
                                    window.location.href = "{{URL::to('admin/about-listing')}}"
                                }, 2000);
                            }
