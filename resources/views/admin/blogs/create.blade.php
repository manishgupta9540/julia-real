...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-10">
            <form action="{{route('blogs-create')}}"  method="POST" id="blogscreate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Create a New Blogs </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success==true) {   
                            toastr.success("Blogs created Successfully");
                            window.setTimeout(function() {
