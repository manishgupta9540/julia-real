            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <a href="{{route('categoryes-create')}}" class="btn btn-primary btn-sm ">Add category</a>
                        <br>
        ...
        $(document).on('click', '.status', function (event) {
            ...
            function(e){
                if(e==true)
                {
                    $.ajax({
                        type:'POST',
                        url: "{{url('admin/categoryes-status')}}",
