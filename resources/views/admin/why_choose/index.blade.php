            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <?php
                            $allreadyexist = DB::table('why_chooses')->count();
                        ?>
                        @if($allreadyexist == null)
                            <a href="{{route('why-choose-create')}}" class="btn btn-primary btn-sm ">Add why choose</a>
                        @else
        ...
        $(document).on('click', '.status', function (event) {
            ...
            function(e){
                if(e==true)
                {
                    $.ajax({
                        type:'POST',
                        url: "{{url('admin/why-choose-status')}}",
