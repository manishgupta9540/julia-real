...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('why-choose-update')}}"  method="POST" id="blogscreate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Edit Why Choose Us </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                @endif
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Enter the Description" name="description">{{$choose->description}}</textarea>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(response.success==true) {   
                            ...
                            window.setTimeout(function() {
                                window.location.href = "{{URL::to('admin/why-choose-list')}}"
                            }, 2000);
                        }
