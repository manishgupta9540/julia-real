            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <?php
                            $allreadyexist = DB::table('find_sellings')->count();
                        ?>
                        @if($allreadyexist == null)
                            <a href="{{route('find-sell-create')}}" class="btn btn-primary btn-sm ">Add Find Selling</a>
                        @else
        ...
        $(document).on('click', '.status', function (event) {
            ...
            function(e){
                if(e==true)
                {
                    $.ajax({
                        type:'POST',
                        url: "{{url('admin/find-sell-status')}}",
