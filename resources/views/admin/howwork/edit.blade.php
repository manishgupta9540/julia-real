...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('howWork-update')}}"  method="POST" id="workUpdate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Edit We Work </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <input type="hidden" name="id" value="{{ base64_encode($work->id) }}">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Enter the description" id="description" name="description">{{ $work->description }}</textarea>
...
<script>
    ...
    <script>
        $(document).on('submit', 'form#workUpdate', function (event) {
