...
@section('title','Faq Rent Listing')
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <a href="{{route('faq-rent-create')}}" class="btn btn-primary btn-sm ">Add Faq Rent</a>
                        <br>
