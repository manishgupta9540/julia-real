...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-11">
            <form action="{{route('faq-rent-update')}}"  method="POST" id="faqrentupdate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Edit Faq Rent </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
...
<script>
    ...
    <script>
          $(document).on('submit', 'form#faqrentupdate', function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response.success==true) {   
                                toastr.success("Faq Rent Updated Successfully");
                                window.setTimeout(function() {
