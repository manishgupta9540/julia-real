            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        @php
                            $dreamExist = DB::table('get_your_dreams')->count();
                        @endphp
                        @if ($dreamExist == null)
                            <a href="{{route('get-your-dream-create')}}" class="btn btn-primary btn-sm ">Add Your Dream</a>
                        @else
        ...
        $(document).on('click', '.status', function (event) {
            ...
            function(e){
                if(e==true)
                {
                    $.ajax({
                        type:'POST',
                        url: "{{url('admin/get-your-dream-status')}}",
