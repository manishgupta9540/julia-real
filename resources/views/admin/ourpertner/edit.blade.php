...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
        <div class="col-md-10">
            <form action="{{route('pertner-update')}}"  method="POST" id="pertnerupdate" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
                        <div class="card radius shadow-sm">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                    <h4 class="card-title mb-1 mt-3">Edit Partner </h4>
                                    <p class="pb-border"> </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <input type="hidden" name="id" value="{{base64_encode($pertner->id)}}">
                                    {{-- <div class="col-sm-6">
                                    ...
                                    <br>
                                    @if($pertner->image!=NULL && file_exists(public_path('uploads/blogs/'.$pertner->image)))
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <a href="{{asset('uploads/blogs/'.$pertner->image)}}" target="_blank">
                                                    <img src="{{asset('uploads/blogs/'.$pertner->image)}}" width="100px" height="100px">
                                                </a>
                                            </div>
                                        </div>
                                    @endif
...
<script>
    ...
    <script>
          $(document).on('submit', 'form#pertnerupdate', function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response.success==true) {   
                                toastr.success("Pertner Updated Successfully");
                                window.setTimeout(function() {
