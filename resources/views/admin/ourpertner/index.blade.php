...
@section('title','Our Partner Listing')
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <a href="{{route('oure-pertner-create')}}" class="btn btn-primary btn-sm ">Add new partner</a>
                        <br>
